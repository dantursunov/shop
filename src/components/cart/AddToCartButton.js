	...
	return (
		<div>
			...
			{ "ExternalProduct" === product.__typename ? (
				...
				<button onClick={ handleAddToCartClick } className="px-3 py-1 rounded-sm mr-3 text-sm border-solid border border-current hover:bg-black hover:text-white hover:border-blue-300">Add to cart</button>
			}
			{ showViewCart ? (
